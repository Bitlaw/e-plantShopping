...
// Main component for displaying plant products and managing cart functionality
function ProductList(props) {
  ...
  // Handle adding items to cart using Redux
  ...
  // Handle navigation back to landing page (close current page)
  const handleLogoClick = (e) => {
    e.preventDefault();
    // Call the function to hide/close this page and show landing page
    if (props.onClose) {
      props.onClose();
    } else if (props.toLanding) {
      props.toLanding();
    } else {
      console.error("No close function provided in props");
    }
  };
  ...
  return (
    <div>
      ...
      <div className="navbar" style={styleObj}>
        <div className="tag">
          <div className="luxury">
            ...
            >
              <h3 style={{ color: "white", margin: "5px 0" }}>Ziad's Plants</h3>
              <i style={{ color: "white", margin: "5px 0" }}>
      ...
      {/* Conditional rendering: show plants or cart based on state */}
      {!showCart ? (
        // Plant grid display
        <div className="product-grid">
          <br></br>
          {plantsArray.map((item, index) => (
            <div key={index} className="mainCategoryDiv">
              <h1>{item.category}</h1>
              <div className="product-list">
                {item.plants.map((plant, plantIndex) => (
                  <div key={plantIndex} className="product-card">
                    ...
                    <br></br>
                    <p>{plant.cost}</p>
                    {/* Add to cart button with conditional styling */}
                    <button
                      style={{
